      ...
      <div className={homeStyle.container}>
        ...
        <div className={homeStyle.mainCenterData}>
          <div className={homeStyle.wordMark}>
            <h1 className={homeStyle.textELIT}> Elit</h1> <pre> </pre>{" "}
            <h1 className={homeStyle.textDYNAMON}>Dynamon</h1>
          </div>
        ...
        <div className={homeStyle.socialMediaPresence}>
          <div className={homeStyle.iconsLinks}>
            <div className={homeStyle.icon}>
              <IconButton>
                <a href="https://github.com/Elit-Dynamon" target="_blank">
                  <GitHubIcon />{" "}
                </a>
              </IconButton>
            </div>
            <div className={homeStyle.icon}>
              <IconButton>
                <a href="https://discord.gg/d2X8jxyj6y" target="_blank">
            ...
            <div className={homeStyle.icon}>
              <IconButton>
                <a
                  href="https://www.instagram.com/elit.dynamon/"
                  target="_blank"
                >
                  <InstagramIcon />{" "}
                </a>
            ...
            <div className={homeStyle.icon}>
              <IconButton>
                <a
                  href="https://www.linkedin.com/company/elit-dynamon"
                  target="_blank"
                >
                  <LinkedInIcon />
                </a>
